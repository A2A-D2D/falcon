...
module tb_2bfu_idx_debug;
    ...
    // Debug fal_idx during pack phase
    always @(posedge clk) begin
        if (dut.st == 3) begin  // FC_FFT
            if (dut.gen_fft_fwd_2bfu.u_fft_fwd.state == 1 || 
                dut.gen_fft_fwd_2bfu.u_fft_fwd.state == 2) begin
                $display("T=%0t PACK: state=%0d, fal_idx=%0d, fal_hn_c=%0d, logn_q=%0d",
                         $time, 
                         dut.gen_fft_fwd_2bfu.u_fft_fwd.state,
                         dut.gen_fft_fwd_2bfu.u_fft_fwd.fal_idx,
                         dut.gen_fft_fwd_2bfu.u_fft_fwd.fal_hn_c,
                         dut.gen_fft_fwd_2bfu.u_fft_fwd.logn_q);
            end
        end
    end
    ...
    initial begin
        ...
        wait(dut.st == 3);
        #10000;  // Print 1000 cycles of debug
