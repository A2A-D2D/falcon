...
module tb_unified_fpu_debug3;
    ...
    // Debug output every cycle
    always @(posedge clk) begin
        $display("T=%0t st=%0d fpu_v=%b fpu_op=%0d fpu_rsp=%b", 
                 $time, dut.state, dut.fpu_req_valid, dut.fpu_req_op, dut.fpu_rsp_valid);
    end
